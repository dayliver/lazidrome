...
import { deleteAlbumHandler } from '../handlers/albums.delete.js';
...
export default async function albumRoutes(fastify) {
  ...
  fastify.post(
    '/api/albums/:id/enrich',
    {
      config: { rateLimit: { max: 30, timeWindow: '1 minute' } },
    },
    enrichAlbumHandler,
  );
  fastify.delete('/api/albums/:id', { preHandler: [fastify.authenticate] }, deleteAlbumHandler);
}
